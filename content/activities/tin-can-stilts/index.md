...
slug: "tin-can-stilts"
summary: "Transform two tin cans into walking stilts with string handles — decorate them, step up, and stomp around the garden like a giant!"
min_age_months: 48
max_age_months: 144
...
materials:
  ...
  - name: "Tin Cans"
    ...
    optional: false
steps:
  - title: "Prepare the Cans"
    description: "Clean two matching tin cans. An adult pokes two holes near the bottom of each can for the string."
    svg_path: "/activities/tin-can-stilts/step-0.svg"
  - title: "Thread the String"
    description: "Cut long strings, thread through the holes, and tie into loop handles that reach up to standing height."
    svg_path: "/activities/tin-can-stilts/step-1.svg"
  - title: "Decorate Your Stilts"
    description: "Use markers and stickers to decorate the cans — monster feet, rainbows, or robot panels!"
    svg_path: "/activities/tin-can-stilts/step-2.svg"
  - title: "Walk Like a Giant"
    description: "Step onto the cans, hold strings tight, and walk! Keep the strings taut for balance. Stomp!"
    svg_path: "/activities/tin-can-stilts/step-3.svg"
---
