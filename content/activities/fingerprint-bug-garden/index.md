---
title: "Fingerprint Bug Garden"
slug: "fingerprint-bug-garden"
summary: "Press fingertips into paint to stamp colourful bug bodies, then add legs, wings, and antennae with markers — grow a whole garden full of tiny creatures!"
min_age_months: 36
max_age_months: 72
...
materials:
  ...
  - name: "Small Containers"
    ...
    optional: false
steps:
  - title: "Set Up Your Paint Palette"
    description: "Squirt small blobs of three or four poster paint colours into separate sections of a container lid. Press your fingertip gently into one colour to test — you want enough paint for a clear print without smudging."
    svg_path: "/activities/fingerprint-bug-garden/step-0.svg"
  - title: "Press Your Bug Bodies"
    description: "A thumbprint makes a fat bumblebee; four prints in a row make a caterpillar; two prints side by side make butterfly wings. Press firmly onto paper and hold for two seconds before lifting straight up."
    svg_path: "/activities/fingerprint-bug-garden/step-1.svg"
  - title: "Add Bug Details"
    description: "Let the paint dry for five minutes, then use a marker or pen to add six spindly legs on every bug, two curly antennae, black spots on ladybirds, wing outlines on butterflies, and a tiny face on each one."
    svg_path: "/activities/fingerprint-bug-garden/step-2.svg"
  - title: "Create the Garden Scene"
    description: "Draw the world around your bugs: tall grass, flower heads on stems, a sunshine, clouds, and a winding path. Give your garden a name at the top — this is YOUR garden, alive with tiny creatures!"
    svg_path: "/activities/fingerprint-bug-garden/step-3.svg"
---
