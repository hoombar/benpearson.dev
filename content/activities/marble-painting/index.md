...
summary: "Drop marbles into a paint-splattered box, tilt and roll them across paper, and watch as they leave mesmerising swirling trails — every painting is totally unique!"
min_age_months: 48
max_age_months: 96
...
steps:
  - title: "Prepare the Canvas"
    description: "Cut paper to fit inside a cardboard box lid or shallow tray and lay it flat inside so it covers the entire base."
    svg_path: "/activities/marble-painting/step-0.svg"
  - title: "Add the Paint"
    description: "Spoon blobs of 3–4 different poster paint colours onto the paper inside the box, one blob near each corner."
    svg_path: "/activities/marble-painting/step-1.svg"
  - title: "Roll the Marbles"
    description: "Drop 3–4 marbles into the box and tilt it in all directions. Watch the marbles roll through the paint leaving swirling trails."
    svg_path: "/activities/marble-painting/step-2.svg"
  - title: "Reveal Your Artwork"
    description: "Lift the paper out by two corners and lay it flat to dry for 30 minutes. Your unique marble painting is complete!"
    svg_path: "/activities/marble-painting/step-3.svg"
---
