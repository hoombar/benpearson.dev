...
slug: "paper-plate-clock"
summary: "Build a working clock with movable hands from a paper plate — then play time-telling games to learn hours and minutes!"
min_age_months: 36
max_age_months: 120
...
materials:
  ...
  - name: "Stickers"
    ...
    optional: true
steps:
  - title: "Create the Clock Face"
    description: "Write numbers 1-12 around a paper plate rim with markers. Start with 12, 3, 6, 9, then fill in the rest."
    svg_path: "/activities/paper-plate-clock/step-0.svg"
  - title: "Make the Clock Hands"
    description: "Cut two arrow shapes from paper — a long minute hand and short hour hand. Colour them differently."
    svg_path: "/activities/paper-plate-clock/step-1.svg"
  - title: "Attach the Hands"
    description: "Push a paper clip fastener through both hands and the centre hole. Bend on the back so hands spin freely."
    svg_path: "/activities/paper-plate-clock/step-2.svg"
  - title: "Play Time-Telling Games!"
    description: "Call out times and race to set them. Add stickers at special times like wake-up, lunch, and bedtime!"
    svg_path: "/activities/paper-plate-clock/step-3.svg"
---
