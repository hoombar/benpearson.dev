---
title: "Clothespin Stunt Plane"
slug: "clothespin-stunt-plane"
summary: "Build a miniature stunt plane from a clothespin and popsicle sticks, paint it with racing stripes, then launch it on daring flying missions!"
min_age_months: 36
max_age_months: 120
...
steps:
  - title: "Build the Wings"
    description: "Slide a popsicle stick through the clothespin slit so it sticks out equally on both sides as wings. Glue in place."
    svg_path: "/activities/clothespin-stunt-plane/step-0.svg"
  - title: "Add the Tail"
    description: "Glue half a popsicle stick across the back as a tail stabiliser. Add a small upright rectangle as the vertical tail fin."
    svg_path: "/activities/clothespin-stunt-plane/step-1.svg"
  - title: "Paint Your Stunt Plane"
    description: "Paint in bold racing colours and use markers to add a pilot number, stars, or lightning bolts on the wings."
    svg_path: "/activities/clothespin-stunt-plane/step-2.svg"
  - title: "Test Flight!"
    description: "Hold by the body and launch gently! Experiment with throwing angles and set up a landing strip to practise accuracy."
    svg_path: "/activities/clothespin-stunt-plane/step-3.svg"
---
