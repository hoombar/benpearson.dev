...
slug: "paper-plate-fish"
summary: "Cut a wedge from a paper plate for the mouth, reattach it as the tail, then paint colourful scales and add a googly eye for a fantastic fish!"
min_age_months: 36
max_age_months: 108
...
materials:
  ...
  - name: "Tissue Paper"
    ...
    optional: true
steps:
  - title: "Cut the Mouth and Tail"
    description: "Cut a triangle wedge from one side of a paper plate — this is the mouth. Save the wedge for the tail!"
    svg_path: "/activities/paper-plate-fish/step-0.svg"
  - title: "Attach the Tail"
    description: "Flip the wedge and glue it to the opposite side, pointing outward. Mouth on one end, tail on the other!"
    svg_path: "/activities/paper-plate-fish/step-1.svg"
  - title: "Paint the Scales"
    description: "Paint a base colour, then add overlapping curved lines for scales in blues, greens, and purples."
    svg_path: "/activities/paper-plate-fish/step-2.svg"
  - title: "Add Details"
    description: "Stick on a googly eye, glue tissue paper fins, and draw a smile and gill lines!"
    svg_path: "/activities/paper-plate-fish/step-3.svg"
---
