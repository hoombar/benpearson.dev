---
title: "Spaghetti & Marshmallow Tower Challenge"
slug: "spaghetti-marshmallow-tower"
summary: "Use only dry spaghetti sticks and marshmallows to engineer the tallest freestanding tower you can build — then try to beat your record!"
min_age_months: 72
max_age_months: 144
...
materials:
  ...
  - name: "Uncooked Spaghetti"
    ...
    optional: false
steps:
  - title: "Set Up Your Building Site"
    description: "Tip out 20 spaghetti sticks and 20 marshmallows onto a flat table. Keep your ruler nearby — you'll measure your finished tower at the end. Clear plenty of space so your tower has room to sway!"
    svg_path: "/activities/spaghetti-marshmallow-tower/step-0.svg"
  - title: "Build a Strong Base"
    description: "Connect four marshmallows in a square by pushing a spaghetti stick between each pair. Aim for a square about 8–10 cm wide. A wide base is the secret to a tall tower!"
    svg_path: "/activities/spaghetti-marshmallow-tower/step-1.svg"
  - title: "Stack Upward"
    description: "Place a marshmallow on top of each base corner. Push spaghetti sticks between top-corner marshmallows to form a second layer. Keep repeating to reach the ceiling!"
    svg_path: "/activities/spaghetti-marshmallow-tower/step-2.svg"
  - title: "Measure and Record"
    description: "Gently let go. Does it stand? Measure the height with your ruler and write it down. Then build a second tower — what would you do differently this time?"
    svg_path: "/activities/spaghetti-marshmallow-tower/step-3.svg"
---
