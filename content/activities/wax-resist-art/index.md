...
slug: "wax-resist-art"
summary: "Draw a secret picture in white wax, then sweep a wash of colour across the paper and watch your hidden artwork magically appear."
min_age_months: 48
max_age_months: 96
...
materials:
  ...
  - name: "Small Containers"
    icon: "🫙"
    optional: false
  - name: "White Wax Crayon"
    icon: "🕯️"
    optional: false
steps:
  - title: "Draw Your Secret"
    description: "Press a white wax crayon firmly onto white paper to draw a bold picture. The drawing will be nearly invisible — that's the magic!"
    svg_path: "/activities/wax-resist-art/step-0.svg"
  - title: "Mix Your Paint Wash"
    description: "Squeeze poster paint into a container, add 3–4 tablespoons of water, and stir into a thin flowing colour wash. Vivid colours work best."
    svg_path: "/activities/wax-resist-art/step-1.svg"
  - title: "Reveal the Magic"
    description: "Sweep the colour wash boldly across the entire paper. Watch your secret drawing magically appear as the wax pushes the colour away!"
    svg_path: "/activities/wax-resist-art/step-2.svg"
---
