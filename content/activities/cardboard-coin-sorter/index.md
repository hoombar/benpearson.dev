...
summary: "Build a working coin sorting machine from a cardboard box with slots of different sizes — drop coins in the top and watch them sort themselves!"
min_age_months: 60
max_age_months: 144
...
steps:
  - title: "Prepare the Box"
    description: "Stand a shoebox on its side. Cut a cardboard ramp piece to fit diagonally inside."
    svg_path: "/activities/cardboard-coin-sorter/step-0.svg"
  - title: "Cut the Sorting Slots"
    description: "Measure your coins. Cut slots in the ramp — smallest first, each one slightly wider than its coin."
    svg_path: "/activities/cardboard-coin-sorter/step-1.svg"
  - title: "Assemble the Machine"
    description: "Tape the ramp inside at an angle. Add dividers below to create compartments for each coin size."
    svg_path: "/activities/cardboard-coin-sorter/step-2.svg"
  - title: "Test and Label"
    description: "Drop coins in to test. Adjust slots that are too tight or wide. Label and decorate your machine!"
    svg_path: "/activities/cardboard-coin-sorter/step-3.svg"
---
